...
public class PatientInfoTableForLap extends javax.swing.JFrame {

    Connection con = null;
    ResultSet rs = null;
    PreparedStatement pst = null;

    public PatientInfoTableForLap() {
        initComponents();
       // GetData();
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String add4 = rs.getString("RemarkFromDoctorToLab");
                frm.txtRemarkFromDoctor.setText(add4);
                 String add5 = rs.getString("RemarkToDoctorFromLab");
    ...
    private void bSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSearchActionPerformed
       ...
       // String sql = "select * from Patient0 where PatientId= '" + txtID.getText().toString() + "'" ;
            String sql="select PatientId as 'Patient ID', Name as ' Name',Disease as'Disease',RemarkFromDoctorToLab as'Remark From Doctor',RemarkToDoctorFromLab as'Remark To Doctor' from Patient0 where PatientId= '" + txtID.getText().toString() + "'" ;  
...
*/
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientInfoTableForLap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientInfoTableForLap().setVisible(true);
            }
        });
    }
