...
public class RoomInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Room Info");
        setBounds(new java.awt.Rectangle(220, 0, 0, 0));
        setResizable(false);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Room Number", "Type", "Cost", "Department", "Status", "Service Charges"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                ...
                frm.cType.setSelectedItem(add2);
                String add6 = rs.getString("ServiceCharges"); 
                frm.txtServiceCharges.setText(add6);
                String add3 = rs.getString("Cost");
                frm.txtCost.setText(add3);
                String add4 = rs.getString("Department");
                frm.cDepartment.setSelectedItem(add4);
                String add5 = rs.getString("Status");
                frm.cStatus.setSelectedItem(add5);
